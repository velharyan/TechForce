...
public class BlogController : Controller
{
    ...
    [
        new("como-escolher-sistema-para-restaurante", "Como escolher um sistema para restaurante", "Checklist pratico para decidir com seguranca e reduzir retrabalho operacional."),
    ...
    public IActionResult Index()
    {
        ...
        ViewData["Description"] = "Artigos estrategicos sobre software, automacao e eficiencia operacional para liderancas tecnicas e comerciais.";
        return View(Posts);
    }
